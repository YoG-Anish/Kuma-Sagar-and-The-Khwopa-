...
function kumasagarandthekhwopa_enqueue_scripts() {
    ...
    wp_enqueue_style('kumasagarandthekhwopa-banner-styles', get_template_directory_uri() . '/assets/css/banner-styles.css', array(), filemtime( get_stylesheet_directory() . '/assets/css/banner-styles.css' ));
    ...
    wp_enqueue_script('kumasagarandthekhwopa-jquery-min', get_template_directory_uri() . '/assets/js/jquery.min.js', array('jquery'), filemtime( get_stylesheet_directory() . '/assets/js/jquery.min.js' ), true);
    wp_enqueue_script('kumasagarandthekhwopa-jquery-migrate-min', get_template_directory_uri() . '/assets/js/jquery-migrate.min.js', array('jquery'), filemtime( get_stylesheet_directory() . '/assets/js/jquery-migrate.min.js' ), true);
    ...
    wp_enqueue_script('kumasagarandthekhwopa-jquery-1.10.2.min', get_template_directory_uri() . '/assets/js/jquery-1.10.2.min.js', array('jquery'), filemtime( get_stylesheet_directory() . '/assets/js/jquery-1.10.2.min.js' ), true);
    wp_localize_script('kumasagarandthekhwopa-loadmore', 'ajax_object', array(
    ...
    wp_enqueue_script('kumasagarandthekhwopa-jquery-fancybox', get_template_directory_uri() . '/assets/js/jquery.fancybox.js', array('jquery'), filemtime( get_stylesheet_directory() . '/assets/js/jquery.fancybox.js' ), true);
    ...
    wp_localize_script('kumasagarandthekhwopa-gallery-loadmore', 'ajax_object', array(
        'ajaxurl' => admin_url('admin-ajax.php'),
    ));
